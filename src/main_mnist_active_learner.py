...
from active_learning_technique.query_by_committee.kvae import Kvae
from active_learning_technique.query_by_committee.svm import SVM
...
if __name__ == "__main__":
    ...
    vae = mnist_vae.load_model(support.vae_dim_code, support.model_path, "cpu")
    vae.to(support.device)
