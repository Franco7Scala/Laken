...
if __name__ == '__main__':
    ...
    parser.add_argument("-mepoch", dest="mepoch", help="Max epoch", type=int, default=50)
    ...
    parser.add_argument('-m', dest="model_type", help="Specify which model to use. (lstm, grus, gruc, grup, exa, lstmla, lstme, mlp, cnn) ", default='lstm')
    ...
    for epoch in range(start_epoch, args.mepoch):
        ...
        print(epoch, train_loss, val_loss, optimizer.param_groups[0]['lr'], batch_train, batch_val, data_train, data_val)
